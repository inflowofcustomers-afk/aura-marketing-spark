...
const pains = [
  { title: "[PAIN HEADLINE 1]", body: "[Body copy describing the pain point.]" },
  { title: "[PAIN HEADLINE 2]", body: "[Body copy describing the pain point.]" },
  { title: "[PAIN HEADLINE 3]", body: "[Body copy describing the pain point.]" },
  { title: "[PAIN HEADLINE 4]", body: "[Body copy describing the pain point.]" },
];
