...
export function WhatIs() {
  return (
    <section className="cream-section pt-28 sm:pt-44 pb-28 sm:pb-44 overflow-hidden">
      <div className="canvas-grid">
        ...
        <Reveal delay={0.08}>
          <h2 className="mt-12 display-canvas text-navy-deep w-[85%] lg:w-[78%]">
            A reactivation engine purpose-built for MedSpas.
          </h2>
        </Reveal>
      </div>

      <div className="mt-20 sm:mt-32 grid lg:grid-cols-[42fr_58fr] gap-16 lg:gap-24 items-center">
        <Reveal delay={0.12}>
          <div className="space-y-10 body-editorial text-navy-deep/85 grid-left-align">
