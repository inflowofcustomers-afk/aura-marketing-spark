  ...
  head: () => ({
    meta: [
      ...
      { title: "AURA Invites™ | Patient reactivation for MedSpa owners" },
      {
        name: "description",
        content:
          "AURA reactivates dormant MedSpa patients with personalized SMS + email sequences that book appointments automatically.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,300;1,400&family=Inter:wght@200;300;400;500&display=swap",
      },
    ],
  }),
